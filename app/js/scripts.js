...
let pTxt = ['Специализируемся на выполнении комплексных инженерных изысканий в сложных горно-геологических условиях уже более пяти лет.',
            'Комплексные инженерные изыскания включают в себя работы и исследования, обеспечивающих максимально полный анализ грунтового массива.',
