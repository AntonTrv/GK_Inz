...
let pTxt = ['Специализируемся на выполнении полного комплекса работ по обеспечению надежной инженерной защиты зданий и сооружений с 1999 года',
            ...
            'Имеем большой опыт по проектированию,комплексным изысканиям и строительству сооружений в различных регионах России и за рубежом'];
...
$(window).scroll( function(){
     ...
     $('.scroll-reveal-side').each( function(i){
  ...
  $(tabEls[i]).on('click',function(){
   ...
   $('#services-next').on('click',function(){
      ...
      switch (count) {
        ...
        //playBtn hover change
        $('.play-btn img').hover(function(){
          this.src='img/groupHover.svg';
        }, function () {
